define({
  "viewer": {
    ...
    "signin": {
      "title": "인증 필요",
      "explainViewer": "응용프로그램에 접근하려면 %PORTAL_LINK%에서 계정으로 로그인하세요.",
      "explainBuilder": "응용프로그램을 구성하려면 %PORTAL_LINK%에서 계정으로 로그인하세요."
    },
    "errors": {
      "boxTitle": "오류가 발생했습니다.",
    ...
    "shareFromCommon": {
      ...
      "open": "열기",
      "embed": "웹페이지에 임베드",
      "embedExplain": "응용프로그램을 웹페이지에 임베드하려면 다음의 HTML 코드를 사용합니다.",
      "size": "크기(너비/높이):",
