define({
  "viewer": {
    ...
    "loading": {
      "long": "Applikasjonen initialiseres",
      "long2": "Takk for at du venter",
      "failButton": "Last inn applikasjonen på nytt"
    },
    "signin": {
      "title": "Krever godkjenning",
      "explainViewer": "Logg på med en konto på %PORTAL_LINK% for å få tilgang til applikasjonen.",
      "explainBuilder": "Logg på med en konto på %PORTAL_LINK% for å konfigurere applikasjonen."
    },
    "errors": {
