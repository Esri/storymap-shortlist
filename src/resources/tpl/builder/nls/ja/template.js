define({
  "builder": {
    ...
    "help": {
      ...
      "shortlistHelp2": "マップ内の既存のポイント データを場所として使用するオプションを含めて、既存の ArcGIS Web マップからショートリストを作成することもできます。そのポイント データをさらに編集するためにショートリスト ビルダーにインポートすることができ、場所が<a href='http://links.esri.com/storymaps/shortlist_layer_template' target='_blank'>ショートリスト データ スキーマ</a>を使用している場合は、そのデータからそのままショートリストを直接動作させることができます。詳細については、<a href='http://links.esri.com/storymaps/faq_shortlist_create_from_webmap' target='_blank'>この FAQ</a> をご参照ください。",
