...
function init() {
	...
	if (DEFAULT_PROXY_URL)
        ...
        /*esri.addProxyRule({
        urlPrefix: "http://yuew.esri.com/arcgis", //http://jing7.esri.com/portal/
        proxyUrl: "http://yuew.esri.com/DotNet10.3/proxy.ashx"
    });*/
        
        //comment out this line if use addProxyRule
