define({
  "viewer": {
    ...
    "loading": {
      ...
      "failButton": "Pārlādēt lietotni"
    },
    "signin": {
      "title": "Nepieciešama autentifikācija",
      "explainViewer": "Lai piekļūtu lietotnei, pierakstieties %PORTAL_LINK%, izmantojot kontu.",
      "explainBuilder": "Lai konfigurētu lietotni, pierakstieties %PORTAL_LINK%, izmantojot kontu."
    },
    "errors": {
      "boxTitle": "Kļūda",
      ...
      "notAuthorizedBuilder": "Jums neesat pilnvarots izmantot %TPL_NAME% veidotāju.",
      "noBuilderIE": "Veidotājs netiek atbalstīts Internet Explorer versijās, kas ir vecākas par %VERSION%. %UPGRADE%",
