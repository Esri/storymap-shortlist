define({
  "builder": {
    ...
    "help": {
      ...
      "shortlistHelp2": "Você também pode criar uma Lista Restrita de um mapa da web do ArcGIS existente, incluindo a opção de utilizar dados de pontos existentes no mapa como lugares. Você pode importar estes dados de ponto no Construtor de Lista Restrita para edição posterior ou, se seus lugares utilizarem <a href='http://links.esri.com/storymaps/shortlist_layer_template' target='_blank'>o esquema de dados da Lista Restrita</a>, direcionar sua Lista Restrita diretamente dos dados \"como está\". Consulte <a href='http://links.esri.com/storymaps/faq_shortlist_create_from_webmap' target='_blank'>este FAQ</a> para mais informações.",
