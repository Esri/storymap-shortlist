define({
  "builder": {
    ...
    "help": {
      ...
      "shortlistHelp2": "Il est possible, par ailleurs, de créer une shortlist à partir d’une carte Web ArcGIS existante ou d’utiliser des données ponctuelles existantes dans la carte en tant qu’emplacements. Vous pouvez importer ces données ponctuelles dans le générateur de shortlists afin d’y apporter des modifications supplémentaires ou les conserver en l’état si vos emplacements sont conformes à la <a href='http://links.esri.com/storymaps/shortlist_layer_template' target='_blank'>structure de données des shortlists</a>. Consultez <a href='http://links.esri.com/storymaps/faq_shortlist_create_from_webmap' target='_blank'>cette FAQ</a> pour en savoir plus à ce sujet.",
