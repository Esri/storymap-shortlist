define({
  "commonCore": {
    "common": {
      ...
      "start": "Algus",
      "loading": "Laen",
      "disabledAdmin": "Selle funktsiooni on administraator välja lülitanud",
      "width": "Laius",
      "height": "Kõrgus",
      "create": "Koosta",
      "yes": "Jah",
    ...
    "builderPanel": {
      ...
      "tooltipNotShared2": "Teie lugu pole jagatud, ainult Teie pääsete sellele ligi.",
