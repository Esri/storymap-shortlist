define({
  "viewer": {
    ...
    "shareFromCommon": {
      ...
      "autoplayExplain1": "سيتقدم وضع التشغيل التلقائي عبر القصة بفاصل منتظم. يعد ذلك مثاليًا في kiosk أو مراقبة العرض العامة، ولكن يرجى العلم أنه قد يعمل على جعل قراءة القصة أكثر صعوبة في مواقف أخرى. لا يتم دعم هذه الميزة في العروض الصغيرة.",
