define({
  "builder": {
    ...
    "help": {
      ...
      "shortlistHelp2": "Sie können auch eine Shortlist aus einer vorhandenen ArcGIS-Webkarte erstellen, einschließlich der Option zum Verwenden vorhandener Punktdaten in der Karte als Orte. Sie können diese Punktdaten zur weiteren Bearbeitung in den Shortlist-Builder importieren. Wenn Ihre Orte <a href='http://links.esri.com/storymaps/shortlist_layer_template' target='_blank'>das Shortlist-Datenschema</a> nutzen, können Sie jeweils den aktuellen Stand der Daten in der Shortlist darstellen. Weitere Informationen dazu finden Sie in <a href='http://links.esri.com/storymaps/faq_shortlist_create_from_webmap' target='_blank'>diesen FAQs</a>.",
