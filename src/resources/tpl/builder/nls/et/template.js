define({
  "builder": {
    ...
    "addFeatureBar": {
      ...
      "import": "Impordi",
      "done": "Valmis",
      "deleteFeature": "Kustuta",
      "move": "Liiguta",
      "locateFeaturesTooltip": "Mõne punkti asukoht tuleb määrata. Klõpsake nende vaatamiseks"
    },
    "detailPanelBuilder": {
    ...
    "migration": {
      ...
      "fieldPicker": {
        ...
        "descriptionField": "Iga koha kirjelduses sisalduv(ad) väli (väljad) ja nende järjekord: ",
        "urlField": "Väli, mis sisaldab iga koha „lisateabe“ URL-i (valikuline): ",
        "none": "puudub",
