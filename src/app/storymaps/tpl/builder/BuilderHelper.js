define([],
	function(){
		...
		return {
			...
			serializeGraphicsLayerToFeatureCollection: function(layer, visibility, graphics)
			{
				var featureCollection = {
					layers: [{
						featureSet: {
			...
			getBlankWebmapJSON: function()
			{
				return {
					item: {
						...
						"name": null,
						"type": "Web Map",
						"typeKeywords": ["ArcGIS Online", "Explorer Web Map", "Map", "Online Map", "Web Map", "Story Maps", "Shortlist"],
						"description": null,
						"tags": ["map"],
						"snippet": null,
