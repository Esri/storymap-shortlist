define({
  "viewer": {
    ...
    "loading": {
      "long": "Aplikacija se pokreće",
      "long2": "Hvala vam na čekanju",
      "failButton": "Ponovo učitaj aplikaciju"
    },
    "signin": {
      "title": "Potrebna je provjera autentičnosti",
      "explainViewer": "Prijavite se računom za %PORTAL_LINK% da biste pristupili aplikaciji.",
      "explainBuilder": "Prijavite se računom za %PORTAL_LINK% da biste konfigurirali aplikaciju."
    },
    "errors": {
      ...
      "signOut": "Odjava",
      "attention": "Pozor!",
      "noBuilderEdge": "Story Map Shortlists mogu se prikazati u bilo kojem web pregledniku. Međutim, Story Map Shortlist Builder nije podržan za Windows Edge. Upotrijebite drugi web preglednik za stvaranje ili uređivanje Shortlista.",
