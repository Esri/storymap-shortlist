define({
  "viewer": {
    ...
    "signin": {
      ...
      "explainViewer": "Inicie sesión con una cuenta en %PORTAL_LINK% para acceder a la aplicación.",
      "explainBuilder": "Inicie sesión con una cuenta en %PORTAL_LINK% para configurar la aplicación."
    },
    "errors": {
      ...
      "noBuilderAllIE": "Las Story Map Shortlist pueden visualizarse en cualquier navegador web. Sin embargo, el Builder de Story Map Shortlist no es compatible con Microsoft Edge ni Internet Explorer. Use otro navegador para crear o editar una Shortlist."
    },
    "headerFromCommon": {
      ...
      "bitlyTooltip": "Obtener un vínculo corto",
