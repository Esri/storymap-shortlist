define({
  "builder": {
    ...
    "help": {
      ...
      "shortlistHelp2": "Pode ainda criar uma Shortlist a partir de um mapa web ArcGIS existente, incluindo a opção para utilizar dados de pontos existentes nos mapas, como locais. Pode importar esses dados de pontos para o Shortlist Builder para posterior edição ou, caso os seus locais utilizem <a href='http://links.esri.com/storymaps/shortlist_layer_template' target='_blank'>o esquema de dados Shortlist</a>, derive a sua Shortlist diretamente desses dados 'tal como se encontra'. Consulte <a href='http://links.esri.com/storymaps/faq_shortlist_create_from_webmap' target='_blank'>estas FAQ</a> para obter mais informações sobre este assunto.",
