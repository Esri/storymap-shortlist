define({
  "builder": {
    ...
    "detailPanelBuilder": {
      ...
      "imageSizeHelperUpdated": "圖片連結必須以 HTTPS 開頭。<br><br>為獲得最佳效能，圖片必須少於 400 KB。 若要減少檔案大小，請使用以 80% 圖片品質儲存的 JPG 格式。 如果圖片仍超過 400 KB，重新調整大小可進一步減少檔案大小: 建議 1000 像素寬 x 750 像素高 (4:3 寬:高比率)。<br><br>如果連結的圖片繪製緩慢，或無法透過 HTTPS 使用，請將它上傳到您的故事以獲得更好的結果。",
      "thumbnailLink": "縮圖連結",
      "thumbnailHelp": "縮圖連結必須以 HTTPS 開頭。<br><br>建議的縮圖大小和形狀是 280 x 210 像素 (4:3 寬度:高度比例)。 較大的縮圖可能會使效能下降。長寬比為 4:3 的縮圖可填入其圖磚而不會被截斷。"
    },
    "settings": {
      ...
      "bookmarksHelp": "若要啟用書籤，請關閉「候選名單建立器」，然後開啟此「候選名單」中使用的 Web 地圖 (透過 ArcGIS 的「我的內容」或「我的故事」)，再使用 ArcGIS 地圖檢視器將書籤新增至其中。",
      "generalOptions": "一般選項",
      "mapOptions": "地圖選項",
      "changeBasemap": "變更底圖",
