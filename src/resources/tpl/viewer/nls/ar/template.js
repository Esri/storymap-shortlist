define({
  "viewer": {
    ...
    "errors": {
      ...
      "attention": "انتبه!",
      "noBuilderEdge": "يمكن عرض القوائم المختصرة لخريطة القصة في أي مستعرض ويب. ومع ذلك، لا يتم دعم منشيء القائمة المختصرة لخريطة القصة على حافة النوافذ. الرجاء استخدام مستعرض ويب آخر لإنشاء أو تحرير قائمة مختصرة.",
      "noBuilderAllIE": "يمكن عرض القوائم المختصرة لخريطة القصة في أي مستعرض ويب. ومع ذلك، لا يتم دعم منشئ القائمة المختصرة لخريطة القصة على Microsoft Edge أو Internet Explorer. يرجى استخدام مستعرض ويب آخر لإنشاء أو تحرير قائمة مختصرة."
    },
    "headerFromCommon": {
      "storymapsText": "خريطة قصة",
      "builderButton": "تحرير",
      "facebookTooltip": "مشاركة على Facebook",
      "twitterTooltip": "مشاركة على Twitter",
    ...
    "general": {
      "noPlaces": "لا توجد أي أماكن في هذه المنطقة. قم بالتصغير أو انقر على زر الصفحة الرئيسية لرؤية الأماكن.",
      "start": "بدء"
    }
  }
});