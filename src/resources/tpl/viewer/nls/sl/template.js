define({
  "viewer": {
    ...
    "loading": {
      "long": "Aplikacija se inicializira",
      "long2": "Hvala, da čakate",
      "failButton": "Ponovno naložite aplikacijo"
    },
    "signin": {
      "title": "Obvezno je preverjanje pristnosti",
      "explainViewer": "Za dostop do aplikacije se prijavite z računom na %PORTAL_LINK%.",
      "explainBuilder": "Za konfiguracijo aplikacije se prijavite z računom na %PORTAL_LINK%."
    },
    "errors": {
      ...
      "invalidConfigNoAppDev": "Identifikator aplikacije za spletno kartiranje ni naveden v parametrih URL (?appid=). V razvijalskem načinu je prezrta konfiguracija za appid v index.html.",
      ...
      "invalidApp": "Predloga %TPL_NAME% ne obstaja ali do nje ni mogoče dostopiti.",
      "appLoadingFail": "Nekaj ni v redu, predloga %TPL_NAME% se ni pravilno naložila.",
      ...
      "signOut": "Odjava",
      "attention": "Pozor!",
      "noBuilderEdge": "Karte z zgodbami kratkih seznamov si je mogoče ogledati v vseh spletnih brskalnikih, vendar graditelj Kart z zgodbo kratkih seznamov ni podprt v Windows Edge. Uporabite drug spletni brskalnik za ustvarjanje ali urejanje Kratkega seznama.",
      "noBuilderAllIE": "Karte z zgodbami kratkih seznamov si je mogoče ogledati v vseh spletnih brskalnikih, vendar graditelj kart z zgodbo kratkih seznamov ni podprt v brskalniku Microsoft Edge ali Internet Explorer. Uporabite drug spletni brskalnik za ustvarjanje ali urejanje kratkega seznama."
    },
    "headerFromCommon": {
