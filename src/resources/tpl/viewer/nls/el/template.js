define({
  "viewer": {
    ...
    "shareFromCommon": {
      ...
      "autoplayExplain1": "Η λειτουργία αυτόματης αναπαραγωγής θα εξελίσσεται σε τακτά διαστήματα στη διάρκεια της αφήγησής σας. Αυτό είναι ιδανικό κατά την προβολή σε ένα περίπτερο ή σε μια δημόσια οθόνη, αλλά θα πρέπει να έχετε υπόψη σας ότι σε άλλες περιπτώσεις ενδέχεται να καταστήσει δύσκολη την ανάγνωση της ιστορίας σας. Η δυνατότητα αυτή δεν υποστηρίζεται σε μικρές οθόνες.",
    ...
    "general": {
      "noPlaces": "Δεν υπάρχουν μέρη σε αυτήν την περιοχή. Απομακρυνθείτε σε μικρότερη κλίμακα ή κάντε κλικ στο κουμπί αρχικής σελίδας για να εμφανιστούν μέρη.",
      "start": "Εκκίνηση"
    }
  }
});